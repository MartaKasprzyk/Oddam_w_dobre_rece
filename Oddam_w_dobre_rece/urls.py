"""
URL configuration for Oddam_w_dobre_rece project.
...
urlpatterns = [
    ...
    path('donation_update_status/<int:pk>/', views.UserPageUpdateDonationView.as_view(), name='donation_update_status'),
